...
A prime example of SIM can be found in the WikiMusic API project, designed with SIM in mind from the start, and making use of free monads and interpreters: https://gitlab.com/jjba-projects/wikimusic-api
